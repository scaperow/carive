...
import hashlib
import urllib2
verfyURL = {"https": "https://mapi.alipay.com/gateway.do?service=notify_verify&",
     "http": "http://notify.alipay.com/trade/notify_query.do?"}
gateway = "https://mapi.alipay.com/gateway.do"

class alipay:
    def __init__(self,
                 partner="2088511883511290",                    #PID
                 key="h42bxscsm77npyq7v8x4erfit31vrhq4",		#key
                 sellermail="pay@kingrocket.com",				#账户
                 notifyurl="http://127.0.0.1:8889/alipay/notify",  #异步通知回调URL
                 returnurl="http://127.0.0.1:8889/alipay/return",  #跳转回调URL
                 showurl="产品页面"):                           #产品页面
